...
const Error = ({ code=true, btn='Go to home',route='/' ,head="Sorry we couldn't find this page."}) => {
  return (
    <>
      <div className="w-screen my-10 bg-gray-100 flex items-center justify-around">
        <div className="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700">
          <div className="max-w-md">
            ...
            <Link to={route} className="px-4 inline py-2 text-sm font-medium leading-5 shadow text-white transition-colors duration-150 border border-transparent rounded-lg focus:outline-none focus:shadow-outline-blue bg-blue-600 active:bg-blue-600 hover:bg-blue-700">
              {btn}
            </Link>
          </div>
